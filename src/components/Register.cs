@model Cinema.Domain.DTO.UserRegisterDto
@{
...
<div class="container">
    ...
    <form asp-action="Register" asp-controller="Account" method="post">
        ...
        <div class="registerdiv">
            ...
            <div hidden class="form-group col-sm-12">
                <label asp-for="@Model.Role" class="col-lg-3 control-label"></label>
                <br>
                <div class="col-lg-9">
                    <input disabled value="User" asp-for="@Model.Role" class="form-control" />
